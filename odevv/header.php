...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index">Yazılım güncesi</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
        <?php
$query = $baglanti->query("SELECT * FROM menu_listesi where durum=1 order by sira asc", PDO::FETCH_ASSOC);
if ( $query->rowCount() ){
     foreach( $query as $row ){
    
        	?>

<li ><a href="<?=$row['link']?>"><?=$row['baslik']?></a></li>
